<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            <h2 class="section-title"><?=$sub_judul2 ?></h2>
            <p class="section-lead">Silakan Input Data Pengeluaran atau Pemasukan Kas.</p>
                    ...
                    <form action="" method="post">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <button type="submit" class="btn btn-primary"><i class="fas fa-edit"></i> <?=$tombol_simpan?></button>
                                </div>
                            </div>
                    </form>
                </div>
