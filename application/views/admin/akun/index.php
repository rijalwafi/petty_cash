        ...
        <div class="section-body">
            ...
            <div class="row">
                <div class="col-12 col-md-12 col-lg-12">
                    <a href="<?= base_url('admin/akun/tambah'); ?>" class="btn btn-primary mb-2"><i class="fas fa-plus"></i><?=$tambah_data?></a>
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <h6 class="text-muted">Total <?= $total_rows; ?>akun</h6>
                    ...
                    foreach($divisi as $t) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= base_url('admin/akun/edit/') . $t['no_reff']; ?>" class="btn btn-success"><i
                                                    class="fas fa-edit"></i></a>
                                            <a href="<?= base_url('admin/akun/hapus/') . $t['no_reff']; ?>" class="btn btn-danger"><i
